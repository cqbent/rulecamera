	...
	<header id="masthead" class="site-header" role="banner" <?php if ( get_header_image() != '' ) { echo 'style="background-image: url(' . esc_url( get_header_image() ) . ');"'; } ?>>
		<div class="col-full">
			...
			<div class="site-header-content">
				<div class="contact">
					<span class="call">
						Have a question? <a href="tel:800.785.3266">800.785.3266</a>
					</span>
					<a href="mailto:answers@rule.com">Contact Us</a>
				</div>
				<?php
				...
				<div class="social-links">
					...
					<a class="linkedinsm" href="https://www.linkedin.com/company/rule-boston-camera?trk=company_name" target="_blank"><i class="fa fa-linkedin-square"></i></a>
